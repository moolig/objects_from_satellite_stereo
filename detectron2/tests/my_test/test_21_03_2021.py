...
import sys
sys.path.insert(0,'/home/shmuelgr/PycharmProjects/detectron2/tests/my_test/my_pycss/scale_space')
...
if __name__ == "__main__":
    ...
    # img_path = r'/media/shmuelgr/676f1b15-b0a9-4795-945e-d2a40ccdc70f/Dataset/image_haifa_3/crop_images/images/IT_abus_12_2_m_w_4_h_7.jpg'
    ...
    for i, mask in enumerate(masks):
        ...
        y1, x1 = poly1.exterior.coords.xy
        poly2 = poly1.simplify(1)
        y2, x2 = poly2.exterior.coords.xy
    ...
    rotate_im = cv2.flip(im, 0)

    cv2.imshow('rotate_im', rotate_im)
    cv2.imshow('im', im)
    ...
    for box in np_crop_round:
        ...
        crop_im = cv2.flip(crop_im, 0)
        crop_res_im = cv2.flip(crop_res_im, 0)
